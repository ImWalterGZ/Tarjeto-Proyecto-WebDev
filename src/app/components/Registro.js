...
const SignupSchema = Yup.object().shape({
  name: Yup.string()
    ...
    .required('No se puede dejar vacío.'),
  password: Yup.string()
    .min(8, '¡Muy corta!')
    .max(20, '¡Muy larga!')
    ...
    return (
        <div className='flex content-center justify-center'>
            ...
            <div className={`mb-3 w-[20rem] text-xl text-[#434343]`}>Regístrate para continuar</div>
                <Field name="name"
                    className={`bg-[#000000] bg-opacity-5 border-[.1rem] w-[20rem] h-14 p-5 text-[#434343] focus:outline-none rounded-xl ${errors.name && touched.name ? 'border-red-600' : 'border-[#000000] border-opacity-50'}`} placeholder="Ingresa tu nombre"/>
                    ...
                    className={`bg-[#000000] bg-opacity-5 border-[.1rem] w-[20rem] h-14 p-5 text-[#434343] focus:outline-none rounded-xl ${errors.email && touched.email ? 'border-red-600' : 'border-[#000000] border-opacity-50'}`} placeholder="Ingresa tu correo electronico"/>
                    <div className='mb-3 mt-1'>
                    ...
                    className={`bg-[#000000] bg-opacity-5 border-[.1rem] w-[20rem] h-14 p-5 text-[#434343] focus:outline-none rounded-xl ${errors.passwordConf && touched.passwordConf ? 'border-red-600' : 'border-[#000000] border-opacity-50'}`} placeholder="Ingresa tu contraseña nuevamente"/>
                    <div className='mb-3 mt-1'>
              ...
              bg-red-500 rounded-full hover:bg-red-600 focus:z-10'>¡Crear cuenta!</button></div>
                    <button type="button"  className="mb-4 w-full text-white  bg-[#434343] hover:bg-[#434343]/90 focus:outline-nonefont-medium rounded-full text-sm pl-[4.5rem] pr-0 py-2.5 text-center inline-flex items-center me-2">
