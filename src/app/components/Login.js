        ...
        {({ errors, touched }) => (
          <div className='flex text-center justify-center'>
            ...
            <div className={`mb-4 w-[20rem] text-xl text-[#434343]`}>Inicia sesión para continuar</div>
              ...
              bg-red-500 rounded-full hover:bg-red-600'>¡Ingresar a tarjeto!</button></div>
              <button type="button" className="mb-4 w-full text-white bg-[#434343] hover:bg-[#434343]/90 focus:outline-none font-medium rounded-full text-sm pl-16 py-2.5 text-center inline-flex items-center me-2">
